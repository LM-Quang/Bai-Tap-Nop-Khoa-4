...
import { Table, Tag, Space, Button, Avatar, Popconfirm, Popover, AutoComplete } from "antd";
                                       ...
                                       {record.members?.map((item, index) => {
                                          return (
                                             <tr key={index}>
                                                <td>{item.userId}</td>
                                                <td>
                                                   <img src={item.avatar} width="30" height="30" style={{ borderRadius: "15px" }} alt="avatar" />
                                                </td>
                                                <td>{item.name}</td>
                                                <td>
                                                   <button
